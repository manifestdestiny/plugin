...
const (
	githubTokenEnvVariable = "plugin_GITHUB_ACCESS_TOKEN"
)
...
func (g GistClient) Getcli-plugin-plugin() (*cli-plugin-plugin, error) {
...
// Uploadcli-plugin-plugin uploads local cli-plugin-plugins to Gist
func (g GistClient) Uploadcli-plugin-plugin(content string) error {
	gist := &github.Gist{
