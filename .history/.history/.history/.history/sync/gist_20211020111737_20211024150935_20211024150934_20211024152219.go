...
func (g GistClient) GetSnipplugin() (*Snipplugin, error) {
...
// UploadSnipplugin uploads local snipplugins to Gist
func (g GistClient) UploadSnipplugin(content string) error {
	gist := &github.Gist{
