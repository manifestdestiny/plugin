...
func (g GistClient) Getcli-plugin-snipplugin() (*cli-plugin-snipplugin, error) {
...
// Uploadcli-plugin-snipplugin uploads local cli-plugin-snipplugins to Gist
func (g GistClient) Uploadcli-plugin-snipplugin(content string) error {
	gist := &github.Gist{
