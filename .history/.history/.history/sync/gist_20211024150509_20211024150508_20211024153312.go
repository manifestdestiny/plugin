...
func (g GistClient) Getcli-plugin-snippet() (*cli-plugin-snippet, error) {
...
// Uploadcli-plugin-snippet uploads local cli-plugin-snippets to Gist
func (g GistClient) Uploadcli-plugin-snippet(content string) error {
	gist := &github.Gist{
