...
type GeneralConfig struct {
	SnippluginFile string `toml:"snippluginfile"`
...
// GitLabConfig is a struct of config for GitLabSnipplugin
...
func (cfg *Config) Load(file string) error {
	...
	if err == nil {
		...
		cfg.General.SnippluginFile = expandPath(cfg.General.SnippluginFile)
		return nil
	}
	...
	cfg.General.SnippluginFile = filepath.Join(dir, "snipplugin.toml")
	_, err = os.Create(cfg.General.SnippluginFile)
	if err != nil {
	...
	cfg.Gist.FileName = "snipplugin.toml"

	cfg.GitLab.FileName = "snipplugin.toml"
