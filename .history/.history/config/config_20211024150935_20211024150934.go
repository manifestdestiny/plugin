...
type GeneralConfig struct {
	cli-plugin-snippluginFile string `toml:"cli-plugin-snippluginfile"`
...
// GitLabConfig is a struct of config for GitLabcli-plugin-snipplugin
...
func (cfg *Config) Load(file string) error {
	...
	if err == nil {
		...
		cfg.General.cli-plugin-snippluginFile = expandPath(cfg.General.cli-plugin-snippluginFile)
		return nil
	}
	...
	cfg.General.cli-plugin-snippluginFile = filepath.Join(dir, "cli-plugin-snipplugin.toml")
	_, err = os.Create(cfg.General.cli-plugin-snippluginFile)
	if err != nil {
	...
	cfg.Gist.FileName = "cli-plugin-snipplugin.toml"

	cfg.GitLab.FileName = "cli-plugin-snipplugin.toml"
