...
type GeneralConfig struct {
	pluginFile string `toml:"pluginfile"`
...
// GitLabConfig is a struct of config for GitLabplugin
...
func (cfg *Config) Load(file string) error {
	...
	if err == nil {
		...
		cfg.General.pluginFile = expandPath(cfg.General.pluginFile)
		return nil
	}
	...
	cfg.General.pluginFile = filepath.Join(dir, "plugin.toml")
	_, err = os.Create(cfg.General.pluginFile)
	if err != nil {
	...
	cfg.Gist.FileName = "plugin.toml"

	cfg.GitLab.FileName = "plugin.toml"
