...
type GeneralConfig struct {
	cli-plugin-snippetFile string `toml:"cli-plugin-snippetfile"`
...
// GitLabConfig is a struct of config for GitLabcli-plugin-snippet
...
func (cfg *Config) Load(file string) error {
	...
	if err == nil {
		...
		cfg.General.cli-plugin-snippetFile = expandPath(cfg.General.cli-plugin-snippetFile)
		return nil
	}
	...
	cfg.General.cli-plugin-snippetFile = filepath.Join(dir, "cli-plugin-snippet.toml")
	_, err = os.Create(cfg.General.cli-plugin-snippetFile)
	if err != nil {
	...
	cfg.Gist.FileName = "cli-plugin-snippet.toml"

	cfg.GitLab.FileName = "cli-plugin-snippet.toml"
